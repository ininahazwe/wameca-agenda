...
function TimelineViewer() {
  ...
  return (
      <div className={`timeline-container ${isMobile ? 'mobile' : ''}`}>
          ...
          <div className="timeline-header">
            {config.event.logo && (
                <div className="timeline-logo">
                  <img
                      src={config.event.logo.url}
                      alt={config.event.logo.alt || config.event.name}
                      width={config.event.logo.width}
                      height={config.event.logo.height}
                            ...
                            return (
                                ...
                                >
                                  <div
                                      ...
                                      style={{ backgroundColor: eventTypeConfig.dotColor }}
                                  ></div>
                                  ...
                                  <div className="event-content">
                                    ...
                                    <div className="event-time-container">
                                      <div
                                          className={`event-time ${event.type}`}
        ...
        {/* Social Banner */}
        {config.social.enabled && events.length > 0 && (
